(function ()
{
    ...
    angular
        .module('app.core')
        .directive('whiteboard22222', whiteboardDirective,['Socket22222']);

        /** @ngInject */
        function whiteboardDirective(Socket,$timeout, $q, $interpolate)
        {
            // Runs during compile
            return {
                // name: '',
...
/*(function ()
{
    ...
    angular
        .module('app.core')
        .directive('whiteboard', onEnterDirective,['Socket']);

        /** @ngInject */
        /*function onEnterDirective(Socket,$timeout, $q, $interpolate)
        {
            ...
            var linkFn = function(scope,element,attrs) {
                element.bind("keypress", function(event) {
                    ...
                    alert(11111);
                        ...
                        Socket.emit('drawing', {name:'Thuku'});
